...
export const course_content_item_schema = z.object({
  ...
  videos: z.array(
    z.object({
      video_title: z
        .string()
        .min(4, "video title must be atleast 4 characters"),
      video_url: z.string("enter a valid url"),
      video_length: z.number().min(1, "video length is required"),
      id: z.string().optional(),
      video_description: z
        .string()
        .min(50, "video description must be atleast 50 characters long"),
